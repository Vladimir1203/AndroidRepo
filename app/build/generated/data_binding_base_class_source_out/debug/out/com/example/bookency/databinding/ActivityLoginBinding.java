...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull RelativeLayout rootView, @NonNull EditText emailEt,
      @NonNull TextInputLayout emailTil, @NonNull ImageView iconIv, @NonNull Button loginBtn,
      @NonNull TextView noAccTv, @NonNull EditText passwordEt, @NonNull TextInputLayout passwordTil,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.noAccTv;
      TextView noAccTv = ViewBindings.findChildViewById(rootView, id);
      if (noAccTv == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((RelativeLayout) rootView, emailEt, emailTil, iconIv,
          loginBtn, noAccTv, passwordEt, passwordTil, toolbarRl);
    }
